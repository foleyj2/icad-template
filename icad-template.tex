...
\usepackage{custom}
%\graphicspath{{./}{Graphics/}}%% package graphicx loaded in svproc.cls
...
\author{Joseph Timothy Foley\inst{1,2} \and Clarice Bleil De Souza\inst{3}
  \and Marianna Marchesi\inst{3} \and Camilla Pezzica\inst{3}}
%% The Word template has ORCID right after the affiliation and the email at the end --foley
\authorrunning{Foley \& De Souza et al.}% abbreviated author list (for running head)
\tocauthor{Joseph T. Foley, Clarice Bleil De Souza, Marianna MArchesi, and Camilla Pezzica}
...
Some changes have been made to be closer to the distributed Microsoft Word template at the same location.
  ...
  This template takes care of formatting and placement of the citations, as long as you fill in the BibTeX file \path{references-ad.bib} correctly.
...
\bibliographystyle{bst/splncs03}
